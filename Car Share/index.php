...
<html lang="en">
  <head>
    ...
    <link href="css/bootstrap.min.css" rel="stylesheet">
      ...
      <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyBcIJFQ_frSWpG5GZ82JdSukDSiIq2t3G4"></script>
      ...
      <div class="container-fluid" id="myContainer">
          <div class="row">
              <div class="col-md-6 col-md-offset-3">
                  ...
                  <p class="lead bold">Save Money! Save the Environment!</p>
